...
Administration, Education, Students  and many more specialized  modules.</em></p>
    ...
    String gender = request.getParameter("contact");
...
Statement st = con.createStatement();
    int i = st.executeUpdate("insert into students(name,password,contact,email,address) values('"+username+"','"+dob+"','"+gender+"','"+role+"','" +mail+"')");
    if (i != 0) {
    // assume it was sent
       
      response.sendRedirect("index.jsp?message='registered'#testimonial");
    
}else
{     
response.sendRedirect("index.jsp?status='fail'#contact");
