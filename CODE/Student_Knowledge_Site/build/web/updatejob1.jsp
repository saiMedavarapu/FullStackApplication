...
<div id="templatemo_main">
	...
	String st12=request.getParameter("textfield12");	
         ...
         Connection con1= Dbconnection.getConn();
                  ps=con1.prepareStatement("update jobs set  job_code=?,job_name=?,quali_req=?,skill_req=?,resp_req=?,exp_req=?,vac_open=?,createdby=?,createdon=?,lastdate=?,status=?,location=?,salary=?,status1=? where job_code='"+it1+"'");
    ...
    // assume it was sent
      ...
      response.sendRedirect("admin_home.jsp?mupdate=success#updatejobs");
